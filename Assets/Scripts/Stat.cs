...
public class Stat {
    ...
    public float Normalized => currentValue / (float)maxValue;
    public event Action<int> OnChange;

    public void AddMinValue(int value) {
        minValue += value;
        Recalculate();
    }
    ...
    public void AddBonus(object newBonus, float value) {
        bonusValue[newBonus] = value;
        Recalculate();
    }

    public void RemoveBonus(object newBonus) {
        bonusValue.Remove(newBonus);
        Recalculate();
    }
